...
def handler(job):
    try:
        ...
        output_file = os.path.join(
            OUTPUT_DIR, 
            f"rms_{frequency}hz_{duration}sec_{job_id}.mp4"
        )
